...
int ptm_index(	ptm_local_handle_t local_handle, int32_t flags,
		int num_points, double (*atomic_positions)[3], int32_t* atomic_numbers, bool topological_ordering,	//inputs
		int num_dpoints, double (*atomic_dpositions)[3], int32_t* atomic_dnumbers,	//inputs
