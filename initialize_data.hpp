...
//const refdata_t structure_dcub = { PTM_MATCH_DCUB, 16, 20, 7, NUM_DCUB_GRAPHS, graphs_dcub, ptm_template_dcub, penrose_dcub, mapping_dcub};
//const refdata_t structure_dhex = { PTM_MATCH_DHEX, 16, 20, 7, NUM_DHEX_GRAPHS, graphs_dhex, ptm_template_dhex, penrose_dhex, mapping_dhex};
