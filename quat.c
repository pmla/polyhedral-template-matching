...
static void rotate_quaternion_into_fundamental_zone(int num_generators, double (*generator)[4], double* q)
{
	double max = 0.0;
	int i = 0, bi = -1;
...
{
	rotate_quaternion_into_fundamental_zone(24, generator_cubic, q);
}
